...
;
const metadata = {
    title: 'Abdullah Bakir | Python & Django Developer',
    description: 'Passionate Web Developer specializing in Python, Django, and full-stack development. Based in Berlin, Germany.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
